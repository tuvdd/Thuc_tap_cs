...
@PageTitle("User Filters")
@Route(value = "user-filters", layout = MainLayout.class)
@RolesAllowed("ADMIN")
@Uses(Icon.class)
public class UserFiltersView extends Div {
    ...
    public UserFiltersView(PersonService PersonService) {
        this.samplePersonService = PersonService;
        setSizeFull();
        addClassNames("user-filters-view");
    ...
    public static class Filters extends Div implements Specification<Person> {
        ...
        private final TextField phone = new TextField("Số điện thoại");
        private final DatePicker startDate = new DatePicker("Ngày sinh");
        private final DatePicker endDate = new DatePicker();
        private final MultiSelectComboBox<String> occupations = new MultiSelectComboBox<>("Nghề nghiệp");
        ...
        public Filters(Runnable onSearch) {
            ...
            name.setPlaceholder("Nhập tên");

            occupations.setItems("Unknown", "Giáo viên", "Sinh viên");

            roles.setItems("User", "Admin");
